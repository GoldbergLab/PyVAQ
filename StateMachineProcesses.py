...
# ********************************* SYNC_READY *********************************
                    ...
                    try:
                        ...
                        self.log('Got start time: {t}'.format(t=self.startTime.value))
...
# ********************************* TRIGGERING *********************************
                    ...
                    if not self.scheduleEnabled or (self.scheduleStartTime <= currentTimeOfDay and self.scheduleStopTime <= currentTimeOfDay):
                        ...
                        while len(activeTriggers) < activeTriggers.maxlen:
                            ...
                            if self.verbose >= 1:
                                self.log("Sent new trigger! {s}-{e}, rec period={r}".format(s=newTrigger.startTime, e=newTrigger.endTime, r=self.recordPeriod))
