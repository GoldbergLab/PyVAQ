...
"Mono 8":                       dict(bayer=False, channelCount=1,    ffmpeg=None),
"Mono 12 Packed (IIDC-msb)":    dict(bayer=False, channelCount=1,    ffmpeg=None),
"Mono 12 Packed":               dict(bayer=False, channelCount=1,    ffmpeg=None),
"Mono 16":                      dict(bayer=False, channelCount=1,    ffmpeg=None),
"Bayer GR 8":                   dict(bayer=True,  channelCount=1,    ffmpeg=None),
"Bayer RG 8":                   dict(bayer=True,  channelCount=1,    ffmpeg=None),
"Bayer GB 8":                   dict(bayer=True,  channelCount=1,    ffmpeg=None),
"Bayer BG 8":                   dict(bayer=True,  channelCount=1,    ffmpeg=None),
...
"BayerGR 16":                   dict(bayer=True,  channelCount=1,    ffmpeg=None),
"BayerRG 16":                   dict(bayer=True,  channelCount=1,    ffmpeg=None),
"BayerGB 16":                   dict(bayer=True,  channelCount=1,    ffmpeg=None),
"BayerBG 16":                   dict(bayer=True,  channelCount=1,    ffmpeg=None),
...
"RGB 8":                        dict(bayer=False, channelCount=3,    ffmpeg=None)
}
